...
> The documentation indicates that the 'gayguides' dataset is a compilation of Bob Damron's Address Books (1965-1985). The documentation also mnentions that it was last updated in December 2022. 
...
>I used ?head to bring up the help panel. Within that help panel were instructions on how to use the tail function. With regard to printing out 10 rows instead of 6, I ended up using Google. The websites provided the information in a more digestable manner than the help panel. 
