...
```
> I ended up having to look up what bins do online, since I could not find bins with the help function (?) in the console. 
...
(@) Plot 2 explanation: 
> I wanted to see the population of the Midwest, largely to see which states had the most people. The way that they have the values broken down into counties messed up my bar chart. I decided to make another bar chart that looked at the population for certain counties in Michigan. The results were suprising, since Sagianw has a far larger population compared to Midland (which is to my understanding, a wealthy and growing city).
...
# choosing Gratiot as var 1 and Saginaw as var 2
var1 = 38982
var2 = 211946
